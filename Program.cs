...
public class ApplicationDbContext : DbContext
{
    ...
    //configurar tabelas do Entity Framework
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder options) => options.UseSqlServer(
        "Server=localhost;Database=Products;User Id=sa;Password=26rafinha;MultipleActiveResultSets=true;Encrypt=YES;TrustServerCertificate=YES"
    );
}